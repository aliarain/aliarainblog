...
export const meta = { author: 'Ali Arain', date: '2024-3-11', title: 'Rilando AI ', description: "Rilando AI - your go-to AI autopilot for coding. Leveraging powerful large language models (LLMs), our plugin helps generate, edit,and optimize code, explaining complex sections along the way. Simplify your coding journey; sign up now and let Rilando AI enhance your productivity like never before." }
