...
export const meta = {
  author: 'Ali Arain',
  date: '2023-1-11',
  title: 'Dont Compare Yourself with other',
  description:
    'Most try to compare there self with someone who has a totally different situation and experience with them. this small twitter thread explain why you should not do it',
}
