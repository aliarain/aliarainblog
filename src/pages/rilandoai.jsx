...
export default function Uses() {
    return (
        <>
        <Head>
            <title>rilando ai - ali arain</title>
            <meta
                name="description"
                content="rilando ai - your autopilot with your local llm."
            />
        </Head>
        <SimpleLayout
            title="rilando ai."
            intro="Experience the perfect blend of human intuition and machine brilliance with Rilando AI - your go-to AI autopilot for coding. Leveraging powerful large language models (LLMs),
            our plugin helps generate, edit, and optimize code, explaining complex sections along the way. Simplify your coding journey"
            >
